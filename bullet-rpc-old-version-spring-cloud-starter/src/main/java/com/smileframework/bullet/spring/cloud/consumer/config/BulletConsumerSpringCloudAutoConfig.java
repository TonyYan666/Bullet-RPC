...
public class BulletConsumerSpringCloudAutoConfig {
    ...
    public LoadBalancerRequestInvokerBuilder loadBalancerRequestInvokerBuilder(LoadBalancerClient loadBalancerClient) {
        return new LoadBalancerRequestInvokerBuilder(loadBalancerClient);
    }
