...
@Slf4j
public class ServiceProviderBeanScanner extends ClassPathBeanDefinitionScanner {


    public ServiceProviderBeanScanner(BeanDefinitionRegistry registry, boolean useDefaultFilters, Environment environment, ResourceLoader resourceLoader) {
    ...
    public ServiceProviderBeanScanner(BeanDefinitionRegistry registry, Environment environment,
    ...
    public void registerFilters() {
        ...
        addIncludeFilter(new AnnotationTypeFilter(ServiceProvider.class));
    ...
    protected Set<BeanDefinitionHolder> doScan(String... basePackages) {
        ...
        if (beanDefinitionHolders.isEmpty()) {
            log.warn("No Bullet service provider was found in " + Arrays.toString(basePackages) + " package. Please check your configuration.");
    ...
    protected boolean checkCandidate(String beanName, BeanDefinition beanDefinition) throws IllegalStateException {
        if (super.checkCandidate(beanName, beanDefinition)) {
            ...
            log.warn("Skipping service provider with name '" + beanName + "' and '"
                    + beanDefinition.getBeanClassName() + "' service provider class " + ". Bean already defined with the same name!");
            return false;
        }
    }
